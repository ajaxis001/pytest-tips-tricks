[![Python application test with Github actions](https://github.com/ajaxis001/pytest-tips-tricks/actions/workflows/testing-ci.yml/badge.svg)](https://github.com/ajaxis001/pytest-tips-tricks/actions/workflows/testing-ci.yml)
